...
class _UpcomingGamesWidgetState extends State<UpcomingGamesWidget> {
  ...
  Future<void> _analyzeFixture(Fixture fixture) async {
    final predictor = Provider.of<PredictorProvider>(
      context,
      listen: false,
    ).selectedPredictor;
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Clipboard.setData(
                                  ClipboardData(
                                    text: fixture.fixtureId.toString(),
                                  ),
                                );
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Fixture ID ${fixture.fixtureId} copied to clipboard',
                                    ),
